    ...
    def DumpResult(self):
        ...
        with open(self.resultFilePath, 'w+') as f:
            ...
            for k in range(len(Params)):
                f.write(',{0}_ratio,{0}_speed,{0}_dspeed'.format(Params[k]))
            f.write('\n')
            
            f.write('DatasetName')        
            for k in range(len(Params)):
                f.write(',{0},{0},{0}'.format(Params[k]))
            f.write('\n')
